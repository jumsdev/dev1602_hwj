...
?>
    ...
    <input type="hidden" name="site_cd"         value="<?php echo $wzpconfig['pn_pg_mid']; ?>">
    <input type="hidden" name="site_name"       value="<?php echo $g_conf_site_name; ?>">
    <input type="hidden" name="def_site_cd"     value="<?php echo $wzpconfig['pn_pg_mid']; ?>">
...
?>
    ...
    <input type="hidden" name="good_mny"    value="<?php echo $total_price; ?>">
...
-->
    ...
    <input type="hidden" name="pay_mod" value="<?php echo ($wzpconfig['pn_pg_escrow_use']?"O":"N"); ?>">
...
if($wzpconfig['pn_pg_tax_flag_use']) {
    ...
    if($wzpconfig['pn_pg_tax_free']) {
        $comm_tax_mny   = 0;
        $comm_vat_mny   = 0;
        $comm_free_mny  = $total_price;
    }
    else {
        $comm_tax_mny   = round($total_price / 1.1);
        $comm_vat_mny   = $total_price - $comm_tax_mny;
        $comm_free_mny  = 0;
    }
