...
(function($) {
    ...
    $.fn.juicyslider = function(options) {
        ...
        settings = $.extend({
            ...
            bgcolor: "#000",
            autoplay: 5000, // 0 for no autoplay, any other postive number for play interval in (ms)
        ...
        // set the next button
        this.find('.mnav.next').click({step:1}, turnSlide);
        this.find('.mnav.prev').click({step:-1}, turnSlide);
